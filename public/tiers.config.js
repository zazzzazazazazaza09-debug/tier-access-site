...
window.SITE_CONFIG = {
  ...
  customPack: {
    ...
    categories: [
      ...
      { id: 2, name: "a",  desc: "Premium selection",     color: "amber" },
      { id: 3, name: "a",  desc: "Elite vault",           color: "orange" },
      { id: 4, name: "a",  desc: "Ultra archive",         color: "coral" },
      { id: 5, name: "a",  desc: "VIP exclusive",         color: "rose" },
      { id: 6, name: "a",  desc: "Mega ultimate",         color: "crimson" }
    ],
    sizes: [
